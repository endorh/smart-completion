...
public class CommandCompletionQueryHandler {
   ...
   private void receiveSuggestions(
      ...
      switch (type) {
         case INFORMED: informedSuggestions = suggestions; break;
         case ARG_BLIND: argBlindSuggestions = suggestions; break;
         case WORD_BLIND: wordBlindSuggestions = suggestions; break;
      }
   ...
   public static class SplitCommandQuery {
      private final String command;
      private final int cursor;
      private final int argStartPos;
      private final String argBlindCommand;
      private final String argQuery;
      private final int wordStartPos;
      private final @Nullable String wordBlindCommand;
      private final @Nullable String wordQuery;
      ...
      public SplitCommandQuery(
         ...
         this.cursor = cursor;
         this.argStartPos = argStartPos;
         this.argBlindCommand = argBlindCommand;
         this.argQuery = argQuery;
         this.wordStartPos = wordStartPos;
         this.wordBlindCommand = wordBlindCommand;
         this.wordQuery = wordQuery;
      }

      public String command() { return command; }
      public int cursor() { return cursor; }
      public int argStartPos() { return argStartPos; }
      public String argBlindCommand() { return argBlindCommand; }
      public String argQuery() { return argQuery; }
      public int wordStartPos() { return wordStartPos; }
      public @Nullable String wordBlindCommand() { return wordBlindCommand; }
      public @Nullable String wordQuery() { return wordQuery; }
      ...
      public boolean hasExpired(QueryType type, int pos, String command, String query) {
         switch (type) {
            case INFORMED: return cursor != pos || !command.equals(trimmedCommand());
            case ARG_BLIND: return argStartPos != pos || !argBlindCommand.equals(command) || !argQuery.equals(query);
            case WORD_BLIND: return wordStartPos != pos || !Objects.equals(wordBlindCommand, command) || !Objects.equals(wordQuery, query);
   ...
   public static class CachedSuggestions {
      private final @NotNull CompletableFuture<Suggestions> suggestions;
      private final long timeStamp;

      public CachedSuggestions(@NotNull CompletableFuture<Suggestions> suggestions, long timeStamp) {
         this.suggestions = suggestions;
         this.timeStamp = timeStamp;
      }

      public @NotNull CompletableFuture<Suggestions> suggestions() { return suggestions; }
