...
public class MultiMatcher {
   ...
   private static class MatchState {
      ...
      private final int queryPartIdx;
      private final String queryPart;
      private final String lastMatch;

      private MatchState(int matchCount, int queryPartIdx, String queryPart, String lastMatch) {
         this.matchCount = matchCount;
         this.queryPartIdx = queryPartIdx;
         this.queryPart = queryPart;
         this.lastMatch = lastMatch;
      }

      private int matchCount() { return matchCount; }
      private int queryPartIdx() { return queryPartIdx; }
      private String queryPart() { return queryPart; }
      private String lastMatch() { return lastMatch; }
   }
}
