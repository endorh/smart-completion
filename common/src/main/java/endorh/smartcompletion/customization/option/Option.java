...
public class Option<T> {
   ...
   private void bake(boolean userValueChange) {
      ...
      value = type.override(value, userValue, false);
   ...
   public @Nullable T getUserValue() {
      return userValue;
   }

   public void setUserValue(@Nullable T value) {
      this.userValue = value;
      bake(true);
   }

   public void overrideUserValue(@Nullable T value) {
      overrideUserValue(value, false);
   }
   public void overrideUserValue(@Nullable T value, boolean replace) {
      setUserValue(getType().override(getUserValue(), value, replace));
   }
