...
import endorh.smartcompletion.customization.SmartCompletionCommand.LowerCaseWordArgumentType;
...
public final class SmartCompletionSettings extends OptionCategory<SmartCompletionSettings> {
    ...
    */
   public final SuggestionStyleSettings style = getConfigDirectory() != null? subCategory(SuggestionStyleSettings::new) : null;
   /**
    * Settings related to he caching of queries.
    */
   public final CacheSettings cache = subCategory(CacheSettings::new);

   public SmartCompletionSettings(@Nullable Path configDirectory) {
      super(configDirectory, "settings");
      initializeCategory();
   }
   ...
   public static final class FlatcaseSplittingSettings extends OptionCategory<FlatcaseSplittingSettings> {
      ...
      public final Option<IncludeExcludeSet<String>> suffixes = option(
         OptionType.set(OptionType.string(LowerCaseWordArgumentType.word()), reverseLength()),
   ...
   public static final class CacheSettings extends OptionCategory<CacheSettings> {
      ...
      public CacheSettings(@Nullable Path configDirectory) {
         super(configDirectory, "cache");
         initializeCategory();
      }
   }
}